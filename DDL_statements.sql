...
FOR EACH ROW 
BEGIN 
DECLARE PREVOIUS_ORDERS INT UNSIGNED DEFAULT 0; 
DECLARE ORDER_AMOUNT INT UNSIGNED DEFAULT 0; 
SELECT SUM(QUANTITY) INTO PREVOIUS_ORDERS  
FROM BOOK_STORE.ORDERS WHERE ORDERS.ISBN = ISBN; 
IF NEW.AMOUNT_IN_STOCK < NEW.THRESHOLD 
THEN 
	SET ORDER_AMOUNT = NEW.THRESHOLD - NEW.AMOUNT_IN_STOCK - PREVOIUS_ORDERS; 
